...
PATH="C:/Users/andri/Desktop/курсач/CourseWork/files/test/neg"
...
class Engine:
    ...
    def saveInvIndex(filename, location, texts, words ):
    ...
    def termsearch(terms, txts, finvindex):
    ...
    def phrasesearch(phrase, txts, finvindex):
